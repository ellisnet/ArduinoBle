...
namespace BluetoothLevel.Net.BleHelper
{
    /// <summary>
    ...
    public class ObservableBluetoothLEDevice : INotifyPropertyChanged, IEquatable<ObservableBluetoothLEDevice>
    {
        ...
        public ObservableBluetoothLEDevice(DeviceInformation deviceInfo)
        {
            ...
            //LoadGlyph(); //TODO: Why am I loading a glyph?
        ...
        public void UpdateAsync(DeviceInformationUpdate deviceUpdate) //was: async task
        {
        ...
        private void BluetoothLEDevice_NameChanged(BluetoothLEDevice sender, object args) //was: async void
        {
            //await CoreApplication.MainView.CoreWindow.Dispatcher.RunAsync(
            //    CoreDispatcherPriority.Normal,
            //    () => { Name = BluetoothLEDevice.Name; });
        ...
        /// <param name="sender">The sender.</param>
        /// <param name="args">The arguments.</param>
        private void BluetoothLEDevice_ConnectionStatusChanged(BluetoothLEDevice sender, object args) //was: async void
        {
            //await CoreApplication.MainView.CoreWindow.Dispatcher.RunAsync(
            //    CoreDispatcherPriority.Normal,
            //    () =>
